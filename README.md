...
You can either use environment variables `API_BASE_URL` and `API_ACCESS_KEY` or create a `~/.skaylink/profile.toml` file with your API access details:
...
API_ACCESS_KEY = "<your-prod-api-token>"
```
